    ...
    <>
      ...
      >
            ...
            >
              ...
              <ul className="space-y-2">
                {[
                  {
                    name: "LinkedIn",
                    link: "https://www.linkedin.com/in/samchhabraa/",
                  },
                  { name: "Github", link: "https://github.com/Sam-Chhabra" },
                ].map((item, index) => (
                  <motion.li
                    key={item.name}
                    initial={{ x: 20, opacity: 0 }}
        ...
        >
          ...
          <a href="mailto:samchhabraa@gmail.com" className="text-lg hover:underline">
            samchhabraa@gmail.com
          </a>
        </motion.div>
      </motion.div>
    </>
